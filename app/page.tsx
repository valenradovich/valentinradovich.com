    ...
    <Layout>
      ...
      <div className="text-left">
        ...
        <p className="text-xl mb-4 leading-relaxed">
            ...
            read what i <Link href="/posts" className="underline hover:no-underline">write</Link>, some of my <Link href="https://github.com/valenradovich" className="underline hover:no-underline">code</Link> or thoughts on <Link href="https://x.com/radovichvalen" className="underline hover:no-underline">twitter</Link>.
        </p>
      </div>
    </Layout>
  )
